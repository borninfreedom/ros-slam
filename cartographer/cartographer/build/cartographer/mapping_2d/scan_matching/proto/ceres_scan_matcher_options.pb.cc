...
void protobuf_AddDesc_cartographer_2fmapping_5f2d_2fscan_5fmatching_2fproto_2fceres_5fscan_5fmatcher_5foptions_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "(\001\022K\n\024ceres_solver_options\030\t \001(\0132-.carto"
    "grapher.common.proto.CeresSolverOptions", 479);
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 31) {
    ZR_(occupied_space_cost_functor_weight_, covariance_scale_);
      ...
      case 1: {
        if (tag == 9) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &occupied_space_cost_functor_weight_)));
...
void CeresScanMatcherOptions::SerializeWithCachedSizes(
  ...
  // optional double occupied_space_cost_functor_weight = 1;
  if (has_occupied_space_cost_functor_weight()) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(1, this->occupied_space_cost_functor_weight(), output);
  }
...
::google::protobuf::uint8* CeresScanMatcherOptions::SerializeWithCachedSizesToArray(
  ...
  // optional double occupied_space_cost_functor_weight = 1;
  if (has_occupied_space_cost_functor_weight()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(1, this->occupied_space_cost_functor_weight(), target);
  }
...
void CeresScanMatcherOptions::MergeFrom(const CeresScanMatcherOptions& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_occupied_space_cost_functor_weight()) {
      set_occupied_space_cost_functor_weight(from.occupied_space_cost_functor_weight());
    }
...
void CeresScanMatcherOptions::Swap(CeresScanMatcherOptions* other) {
  if (other != this) {
    std::swap(occupied_space_cost_functor_weight_, other->occupied_space_cost_functor_weight_);
