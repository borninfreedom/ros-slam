...
(cl:defclass <SubmapList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (trajectory
    :reader trajectory
    :initarg :trajectory
    :type (cl:vector cartographer_ros_msgs-msg:TrajectorySubmapList)
   :initform (cl:make-array 0 :element-type 'cartographer_ros_msgs-msg:TrajectorySubmapList :initial-element (cl:make-instance 'cartographer_ros_msgs-msg:TrajectorySubmapList))))
)
...
(cl:defmethod trajectory-val ((m <SubmapList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cartographer_ros_msgs-msg:trajectory-val is deprecated.  Use cartographer_ros_msgs-msg:trajectory instead.")
  (trajectory m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SubmapList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'trajectory)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cartographer_ros_msgs-msg:TrajectorySubmapList))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SubmapList>)))
  ...
  "5b078c8c78f691214539bd5c73670511")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SubmapList)))
  "Returns md5sum for a message object of type 'SubmapList"
  "5b078c8c78f691214539bd5c73670511")
