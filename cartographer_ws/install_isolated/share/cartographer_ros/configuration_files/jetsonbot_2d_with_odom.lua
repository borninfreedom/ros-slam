...
options = {
  ...
  odom_frame = "odom",
  provide_odom_frame = false,	--the odom is the iner odom provided by cartographer,we use extra odom device,so set false
  publish_frame_projected_to_2d = false,
  use_odometry = true,	--this is the extra odom device ,provided by encoder
  use_nav_sat = false,
  use_landmarks = false,
  num_laser_scans = 1,
...
POSE_GRAPH.optimization_problem.odometry_translation_weight = 20
return options
