...
void TableStruct::InitDefaultsImpl() {
  ...
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_5foptions_2eproto::InitDefaults();
  _MapBuilderOptions_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MapBuilderOptions_default_instance_);_MapBuilderOptions_default_instance_._instance.get_mutable()->pose_graph_options_ = const_cast< ::cartographer::mapping::proto::PoseGraphOptions*>(
...
void AddDescriptorsImpl() {
  ...
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_5foptions_2eproto::AddDescriptors();
}
} // anonymous namespace
