...
void TableStruct::InitDefaultsImpl() {
  ...
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto::InitDefaults();
  ...
  _LocalSlamResultData_default_instance_._instance.get_mutable()->node_data_ = const_cast< ::cartographer::mapping::proto::TrajectoryNodeData*>(
      ::cartographer::mapping::proto::TrajectoryNodeData::internal_default_instance());
  _SerializedData_default_instance_.pose_graph_ = const_cast< ::cartographer::mapping::proto::PoseGraph*>(
      ::cartographer::mapping::proto::PoseGraph::internal_default_instance());
  _SerializedData_default_instance_.all_trajectory_builder_options_ = const_cast< ::cartographer::mapping::proto::AllTrajectoryBuilderOptions*>(
      ::cartographer::mapping::proto::AllTrajectoryBuilderOptions::internal_default_instance());
  _SerializedData_default_instance_.submap_ = const_cast< ::cartographer::mapping::proto::Submap*>(
      ::cartographer::mapping::proto::Submap::internal_default_instance());
  _SerializedData_default_instance_.node_ = const_cast< ::cartographer::mapping::proto::Node*>(
      ::cartographer::mapping::proto::Node::internal_default_instance());
  _SerializedData_default_instance_.trajectory_data_ = const_cast< ::cartographer::mapping::proto::TrajectoryData*>(
      ::cartographer::mapping::proto::TrajectoryData::internal_default_instance());
  _SerializedData_default_instance_.imu_data_ = const_cast< ::cartographer::mapping::proto::ImuData*>(
      ::cartographer::mapping::proto::ImuData::internal_default_instance());
  _SerializedData_default_instance_.odometry_data_ = const_cast< ::cartographer::mapping::proto::OdometryData*>(
      ::cartographer::mapping::proto::OdometryData::internal_default_instance());
  _SerializedData_default_instance_.fixed_frame_pose_data_ = const_cast< ::cartographer::mapping::proto::FixedFramePoseData*>(
      ::cartographer::mapping::proto::FixedFramePoseData::internal_default_instance());
  _SerializedData_default_instance_.landmark_data_ = const_cast< ::cartographer::mapping::proto::LandmarkData*>(
...
void AddDescriptorsImpl() {
  ...
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto::AddDescriptors();
